...
export function PlatformForumManagement() {
    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          Site Forum Categories
        </CardTitle>
        <CardDescription>
          Manage the site-wide forum sections shown to all authenticated users.
        </CardDescription>
      </CardHeader>
        ...
        <div className="space-y-4 border rounded-lg p-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              <Label htmlFor="site-forum-cat-name">Name</Label>
              <Input
                id="site-forum-cat-name"
                value={name}
            ...
            <div className="space-y-2">
              <Label htmlFor="site-forum-cat-order">Display order</Label>
              <Input
                id="site-forum-cat-order"
                inputMode="numeric"
                value={displayOrder}
            ...
            <div className="space-y-2">
              <Label>Icon</Label>
              <Select value={icon} onValueChange={(v) => setIcon(v as any)} disabled={createCategory.isPending}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-2">
              <Label>Color</Label>
              <Select value={color} onValueChange={(v) => setColor(v as any)} disabled={createCategory.isPending}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
          ...
          <div className="space-y-2">
            <Label htmlFor="site-forum-cat-desc">Description (optional)</Label>
            <Textarea
              id="site-forum-cat-desc"
              value={description}
