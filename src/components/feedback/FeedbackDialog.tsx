...
export function GlobalFeedbackButton() {
  ...
  const { sidebarVisible, sidebarCollapsed } = useLayoutContext();
  ...
  return (
    <>
      {/* Stacked button group — bottom-left on desktop, bottom-right on mobile */}
      <div className={cn(
        "fixed z-30 flex flex-col gap-2 transition-all duration-300",
        // Mobile: bottom-right above nav
        "bottom-[76px] right-4",
        // Desktop: bottom-left, clear of sidebar
        "md:bottom-6 md:right-auto md:left-6",
        desktopLeft
      )}>
        {/* Feedback button */}
        <Tooltip>
          <TooltipTrigger asChild>
            <button
              ...
              className="rounded-full bg-primary text-primary-foreground shadow-lg transition-transform hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 h-12 w-12 flex items-center justify-center md:h-auto md:w-auto md:px-4 md:py-3 md:gap-2"
        ...
        <a
          ...
          className="hidden md:flex h-auto items-center gap-2 rounded-full bg-[#5865F2] text-white shadow-lg px-4 py-3 transition-transform hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
