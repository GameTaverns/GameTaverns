      ...
      <main className="flex-1">
        <div className="container max-w-4xl py-12 px-4">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h1 className="text-3xl font-display font-bold">{t("legal.privacyPolicy")}</h1>
          ...
          <div className="prose prose-stone dark:prose-invert max-w-none space-y-8">
            {/* The actual legal content stays in English as it's a legal document */}
            {/* Only headings and UI chrome are translated */}
            <section>
            ...
            <section>
              ...
              <p><strong>We do not sell your data.</strong> We share information only in these cases:</p>
              <ul className="list-disc pl-6 space-y-1">
                <li><strong>With library owners:</strong> Contact form submissions are shared with the relevant library owner so they can respond to inquiries.</li>
                <li><strong>Public data:</strong> Library information you mark as public (game collections, ratings summaries) is visible to anyone.</li>
            ...
            <section>
              ...
              <p>GameTaverns provides built-in tools so you can exercise your rights without needing to contact us:</p>
              <ul className="list-disc pl-6 space-y-1">
                <li><strong>Data Export:</strong> Download a complete JSON file of all your data from <em>Dashboard → Settings → Profile → Export All My Data</em>.</li>
                <li><strong>Account Deletion:</strong> Permanently delete your account from <em>Dashboard → Settings → Manage Account</em>.</li>
                <li><strong>Library Clearing/Deletion:</strong> Remove all games from a library or delete an entire library without deleting your account.</li>
              </ul>
              <p className="mt-2">We recommend exporting your data before deleting your account. Deletion is permanent and cannot be undone.</p>
              <p>
            ...
            <section>
              ...
              <p>
                For EU/EEA users: We process data under legitimate interest for service operation. You may contact us at{" "}
                <a href="mailto:admin@gametaverns.com" className="text-primary hover:underline">admin@gametaverns.com</a>{" "}
            ...
            <section>
              ...
              <p>We may update this Privacy Policy periodically. We will notify users of significant changes via email or a prominent notice on the platform.</p>
            </section>
