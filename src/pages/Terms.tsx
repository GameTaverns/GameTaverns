      ...
      <main className="flex-1">
        <div className="container max-w-4xl py-12 px-4">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <h1 className="text-3xl font-display font-bold">{t("legal.termsOfService")}</h1>
          ...
          <div className="prose prose-stone dark:prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <p>You retain ownership of content you create, including library descriptions, game notes, and uploaded images. By posting content, you grant us a non-exclusive license to display and distribute it through the service.</p>
              <h3 className="text-lg font-medium mt-4">Content Responsibility</h3>
              <p>You are responsible for ensuring your content doesn't infringe on others' rights. Game images and descriptions from BoardGameGeek are used under their terms and remain property of their respective owners.</p>
              <h3 className="text-lg font-medium mt-4">Content Removal</h3>
              <p>We may remove content that violates these terms or is reported as infringing. You can delete your own content at any time through your account settings.</p>
            </section>
            ...
            <section>
              ...
              <p>GameTaverns integrates with third-party services including:</p>
              <ul className="list-disc pl-6 space-y-1">
              ...
              <p>Your use of these integrations is subject to their respective terms and privacy policies.</p>
            </section>

            <section>
              <h2 className="text-xl font-semibold border-b pb-2">7. Intellectual Property</h2>
              <p>The GameTaverns service, including its design, code, and branding, is protected by intellectual property laws. You may not:</p>
              <ul className="list-disc pl-6 space-y-1">
                <li>Copy, modify, or distribute our code without permission</li>
                <li>Use our branding to imply endorsement</li>
                <li>Create derivative works based on our service</li>
              </ul>
              <p>Board game names, images, and related content belong to their respective publishers and are used for informational purposes.</p>
            </section>
            ...
            <section>
              ...
              <p>These terms shall be governed by and construed in accordance with the laws of the State of Indiana, United States, without regard to conflict of law principles.</p>
            </section>
