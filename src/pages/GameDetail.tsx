      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="aspect-[3/4] sm:aspect-square max-h-[40vh] xs:max-h-[45vh] sm:max-h-none overflow-hidden rounded-lg bg-muted card-elevated relative group mx-auto w-full max-w-[65vw] xs:max-w-[70vw] sm:max-w-none">
              {allImages.length > 0 ? (
                <>
                  {(() => {
