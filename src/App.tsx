...
const ConciergeBrowsePage = lazy(lazyRetry(() => import("./pages/convention/ConciergeBrowsePage")));
...
function PlatformRoutes() {
  return (
    <Routes>
      ...
      <Route path="/convention/:eventId/concierge" element={<Suspense fallback={<PageLoader />}><ConventionConciergePage /></Suspense>} />
      <Route path="/concierge" element={<Suspense fallback={<PageLoader />}><ConciergeBrowsePage /></Suspense>} />
