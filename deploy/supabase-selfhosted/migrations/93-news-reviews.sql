...
DROP TRIGGER IF EXISTS trg_news_article_votes ON public.news_article_reactions;
...
DROP TRIGGER IF EXISTS trg_review_helpfulness ON public.game_review_votes;
...
DROP TRIGGER IF EXISTS trg_set_reviewer_weight ON public.game_reviews;
...
DROP TRIGGER IF EXISTS trg_verify_review_ownership ON public.game_reviews;
