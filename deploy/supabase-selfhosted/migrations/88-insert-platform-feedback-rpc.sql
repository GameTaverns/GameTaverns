-- =============================================================================
-- GameTaverns Self-Hosted: Insert Platform Feedback RPC
-- SECURITY DEFINER function to insert feedback and return the ID,
-- bypassing SELECT RLS restrictions for non-admin users.
-- =============================================================================
