-- Fix: library_settings_public view was missing foreground columns
-- The columns existed in the table (migration 33) but the view wasn't updated
DROP VIEW IF EXISTS public.library_settings_public;

CREATE VIEW public.library_settings_public AS
SELECT
  id,
  library_id,
  logo_url,
