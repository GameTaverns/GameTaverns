...
CREATE INDEX IF NOT EXISTS idx_personal_loans_library ON public.personal_loans(library_id);
CREATE INDEX IF NOT EXISTS idx_personal_loans_game ON public.personal_loans(game_id);
CREATE INDEX IF NOT EXISTS idx_personal_loans_status ON public.personal_loans(library_id, status);

-- Grant permissions
GRANT ALL ON public.personal_loans TO authenticated;
GRANT SELECT ON public.personal_loans TO anon;
