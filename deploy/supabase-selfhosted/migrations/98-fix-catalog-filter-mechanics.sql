-- Fix: return individual mechanic names (not family names) from catalog filter options
-- The sidebar MECHANIC_CATEGORIES uses granular names like "Worker Placement", "Hand Management"
-- but the old RPC returned family names like "Card Play", "Dice" — causing a mismatch
-- where most mechanics wouldn't appear in the sidebar.
