-- =============================================================================
-- Migration 72: Add profile theme columns to user_profiles table
-- These columns were referenced in the view (migration 70) but never added
-- to the underlying table.
-- =============================================================================

SET LOCAL lock_timeout = '5s';

-- Add profile theme color columns
ALTER TABLE public.user_profiles
  ...
  ADD COLUMN IF NOT EXISTS profile_bg_opacity TEXT;

-- Recreate the public_user_profiles view to ensure it references these columns
-- (migration 70 may have failed silently if columns didn't exist yet)
