...
while true; do
  ...
  RAW_RESPONSE=$(curl -sS \
    ...
    -d "{\"mode\": \"classify-genres\", \"batch_size\": $BATCH_SIZE, \"include_expansions\": true, \"cortex_timeout_ms\": 12000, \"single_item_timeout_ms\": 6000, \"sub_batch_size\": 4, \"request_budget_ms\": 45000, \"max_single_fallbacks_per_sub_batch\": 2}" 2>&1)
