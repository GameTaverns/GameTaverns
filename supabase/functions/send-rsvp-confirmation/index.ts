...
function buildAttendeeEmail(params: {
  ...
  return [
    ...
    '<p style="margin:0;color:#e8d9b0;font-size:13px;font-family:Georgia,serif;">Event Confirmation</p>',
    '</div>',
...
function buildOrganizerEmail(params: {
  ...
  return [
    ...
    '<div style="background:#3d2b1f;padding:24px 32px;text-align:center;">',
    '<img src="https://gametaverns.com/gt-logo.png" alt="GameTaverns" style="max-height:48px;margin-bottom:4px;" />',
    '<p style="margin:0;color:#e8d9b0;font-size:13px;font-family:Georgia,serif;">New RSVP Received</p>',
    '</div>',
    '<div style="padding:32px;">',
